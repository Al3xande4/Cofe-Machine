    ...
    public static int[] buy(int[] ingridience,int waterIndex, int milkIndex, int beansIndex, int moneyIndex, int cupIndex,
        ...
        switch (kind) {
            case 1:
                ...
                break; case 2: if (latte[waterIndex] <= ingridience[waterIndex]) {
                ...
                break; case 3: if (cappuchino[waterIndex] <= ingridience[waterIndex]) {
                ...
                break; case 4: return ingridience; default: System.out.println("Unknown coffee");
                break;
        }
        return ingridience;
    }
